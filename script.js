...
function randomMessage() {
  ...
  p.innerHTML = `<strong>Today's Worship:</strong> ${messages.worship[randNum1]}<br><strong>Today's Practice:</strong> ${messages.do[randNum2]}<br><strong>Today's Memorization:</strong> ${messages.memorize[randNum3]}`;
